...
public class TribeDinner {
    ...
    public static void init(int numBarbers) {
        ...
        takeMealSemaphore = new Semaphore(3);
    }
    ...
    static class State {
        ...
        private static final String _10_PRISTAPOT_DO_KAZANOT_NE_E_PARALELIZIRAN = "Pristapot do kazanot ne e paraleliziran. Treba da moze do trojca paralelno da zemaat hrana.";
